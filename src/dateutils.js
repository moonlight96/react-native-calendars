...
function tomorrow(a,b){
  var  ad= a instanceof XDate &&new XDate(a.getFullYear(),a.getMonth(),a.getDate());  
   var  bd= b instanceof XDate &&new XDate(b.getFullYear(),b.getMonth(),b.getDate());  
var xc=(ad-bd)/1000/60/60/24.0;
  return a instanceof XDate && b instanceof XDate &&
  0<xc&&xc<2
}
